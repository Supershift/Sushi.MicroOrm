...
namespace Sushi.MicroORM
{
    ...
    public class Connector<T> where T : new()
    {
        ...
        /// <returns></returns>
        public virtual SqlStatementResult<TResult> ExecuteSqlStatement<TResult>(SqlStatement<T, TResult> statement) 
        {
        ...
        /// </summary>        
        /// <returns></returns>
        public virtual async Task<SqlStatementResult<TResult>> ExecuteSqlStatementAsync<TResult>(SqlStatement<T, TResult> statement, CancellationToken cancellationToken)
        {
            SqlStatementResult<TResult> result;
            //perform a callback here?
            using (var sqlCommander = new SqlCommander(ConnectionString, CommandTimeout))
