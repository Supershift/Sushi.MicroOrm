...
Please map identity primary key column using Map.Id(). Otherwise use Insert or Update explicitly.");
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        protected DataFilter<T> CreateFetchSingleFilter(int id)
        {
            var primaryKeyColumns = Map.GetPrimaryKeyColumns();
        ...
        {
            var filter = CreateFetchSingleFilter(id);
        ...
        {
            var statement = SqlStatementGenerator.GenerateSqlStatment<T>(DMLStatementType.Select, SqlStatementResultCardinality.SingleRow, Map, filter, sqlText);            
        ...
        public void Update(T entity, DataFilter<T> filter)
        {
            ...
            var sqlStatement = SqlStatementGenerator.GenerateSqlStatment<T>(DMLStatementType.Update, SqlStatementResultCardinality.None, Map, filter, null, entity, false);
        ...
        public void InsertOrUpdate(T entity, bool isIdentityInsert)
        {
            ...
            //generate sql statement
            var statement = SqlStatementGenerator.GenerateSqlStatment<T>(DMLStatementType.InsertOrUpdate, SqlStatementResultCardinality.SingleRow, Map, filter, null, entity, isIdentityInsert);
        ...
        public void Delete(DataFilter<T> filter)
        {
            ...
            var sqlStatement = SqlStatementGenerator.GenerateSqlStatment<T>(DMLStatementType.Delete, SqlStatementResultCardinality.None, Map, filter, null);
        ...
        {
            //generate statement
            var statement = SqlStatementGenerator.GenerateSqlStatment<T>(DMLStatementType.CustomQuery, SqlStatementResultCardinality.MultipleRows, Map, filter, sqlText);
